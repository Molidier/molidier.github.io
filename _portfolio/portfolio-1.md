...
### Bitty Tiny Tapeout Integration & RISC-V→Bitty Translator

A custom 16-bit processor with a 21-instruction ISA, integrated for fabrication via Tiny Tapeout Sky130, together with an assembly-to-assembly translator from RISC-V32E to the Bitty ISA.

- **Bitty Tiny Tapeout integration & RISC-V→Bitty asm-to-asm translator**  
